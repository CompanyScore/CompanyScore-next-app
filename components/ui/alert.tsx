  ...
  'relative w-full rounded-lg border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        ...
        success:
          'border-[var(--success-600)] bg-[var(--success-50)] text-[var(--success-800)] [&>svg]:text-[var(--success-600)]',
        info: 'border-[var(--info-600)] bg-[var(--info-50)] text-[var(--info-800)] [&>svg]:text-[var(--info-600)]',
        warning:
          'border-[var(--warning-500)] bg-[var(--warning-50)] text-[var(--warning-800)] [&>svg]:text-[var(--warning-500)]',
      },
      highlight: {
        true: 'border-l-4',
        false: '',
...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  (
    ...
    const getHighlightBorderColor = () => {
      ...
      switch (type) {
        case 'error':
          return 'border-l-[var(--error-500)]';
        case 'success':
          return 'border-l-[var(--success-600)]';
        case 'info':
          return 'border-l-[var(--info-600)]';
        case 'warning':
          return 'border-l-[var(--warning-500)]';
        default:
          return '';
      }
    };
